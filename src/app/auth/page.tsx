    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-background via-secondary to-background p-4">
      ...
      <Card className="w-full max-w-md shadow-2xl bg-card border-border">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-headline text-foreground">Welcome</CardTitle>
              ...
              <form onSubmit={handleLoginSubmit(onLogin)} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    {...registerLogin("email")}
                    className={`mt-1 ${loginErrors.email ? 'border-destructive focus:ring-destructive' : 'border-input'}`}
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={`mt-1 ${loginErrors.password ? 'border-destructive focus:ring-destructive' : 'border-input'}`}
                  />
              ...
              <form onSubmit={handleSignUpSubmit(onSignUp)} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className={`mt-1 ${signUpErrors.email ? 'border-destructive focus:ring-destructive' : 'border-input'}`}
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={`mt-1 ${signUpErrors.password ? 'border-destructive focus:ring-destructive' : 'border-input'}`}
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={`mt-1 ${signUpErrors.confirmPassword ? 'border-destructive focus:ring-destructive' : 'border-input'}`}
                  />
